                    ...
                    {if $sArticle.has_pseudoprice}
                        ...
                        {block name='frontend_detail_data_pseudo_price_discount_content'}
                            <span class="content--discount">
                                ...
                                <span class="price--line-through-before"><strong>{s name="UVP" namespace="frontend/listing/box_article"}{/s}</strong> </span>
                ...
                <div class='product--price price--unit'>
                    ...
                    {if $sArticle.purchaseunit && $sArticle.purchaseunit != $sArticle.referenceunit}
                        ...
                        {block name='frontend_detail_data_price_unit_reference_content'}
                            (Grundpreis {$sArticle.referenceprice|currency} {s name="Star" namespace="frontend/listing/box_article"}{/s}
                            je {$sArticle.referenceunit} {$sArticle.sUnit.description}).
                        {/block}
                    {/if}
                </div>
            {/block}
