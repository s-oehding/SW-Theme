{* Search Button *}
{block name="frontend_index_checkout_actions_search_trigger"}
	<li class="navigation--entry entry--search" role="menuitem">
		<a href="#" title="{"{s namespace='frontend/index/checkout_actions' name='IndexLinkTriggerSearch'}{/s}"|escape}" class="trigger-search btn">
			<i class="gres-suche"></i>
		</a>
	</li>
{/block}
